...
namespace TVMazeAPI.Models
{
    ...
    public class MazeEpisode
    {
        ...
        /// <summary>
        /// Flag to indicate watched status (Added by mike)
        /// </summary>
        ...
        {
           // if (show != null)
           //     return $"Show: {show.name} (S{Convert.ToInt32(season).ToString("D2")}E{number.ToString("D2")})";
        ...
        public string airdateDisplay
        {
            ...
            {
                if (airdate != null)
                    return ((DateTime)this.airdate).ToString("dd-MM-yyyy");
                else
                    return "n/a";
            }
        }

        public string episodeReference
        {
            get
            {
                return $"S{Convert.ToInt32(season).ToString("D2")}E{number.ToString("D2")}";

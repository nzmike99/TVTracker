...
namespace TVMazeAPI.Models
{
    ...
    public class MazeSeries
    {
        ...
        /// </summary>
        public List<MazeEpisode> Episodes { get; set; }
        /// <summary>
        ...
        public string premieredDisplay
        {
            get
            {
                if (premiered != null && premiered > DateTime.MinValue)
                    return ((DateTime)this.premiered).ToString("dd-MM-yyyy");
                else
                    return "n/a";
            }
        }
